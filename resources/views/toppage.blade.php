                        ...
                        <div class="col-12 col-md-6 custom-content-post-category">
                            ...
                            <div class="text-item-category">
                                <span>Later, when I would meet Binna and learn about his Port
                                    ...
                                    these
                                    modern and contemporary canvases.<p class="text-readmore"><a href="{{ route('postDetail') }}"
            ...
            <div class="post-latest">
                ...
                <div class="title-post-latest-card">
                    <div class="row custom-card-content-post">
                        <div class="col-12 col-md-4 card-title-post">
                            <div class="card-post">
                                <div class="item-card-img">
                                    <div class="img-frame">
                                        <img src="{{ URL::asset('storage/images/Mask Group 4.png') }}" alt="profile Pic"
                                ...
                                <div class="item-card-text">
                                    <div class="row item-text-icon">
                                        <div class="col-6 item-text-icon-left">
                                            ...
                                            <p class="text-item-icon">10 FEB 2018</p>
                                        </div>
                                        <div class="col-6 item-text-icon-right">
                                            <i class="bi bi-person custom-icon-size"></i>
                                            <p class="text-item-icon">Write</p>
                                        </div>
                                    </div>
                                    <div class="item-card-title">
                                        <p>Palatial, palatable Portugal: a long weekend in Porto</p>
                                    </div>
                                    <div class="item-card-extend">
                                        <p><a href="{{ route('postDetail') }}" target="">Read More</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-12 col-md-4 card-title-post">
                            <div class="card-post">
                                ...
                                <div class="item-card-text">
                                    ...
                                    <div class="item-card-extend">
                                        <p><a href="{{ route('postDetail') }}">Read More</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
