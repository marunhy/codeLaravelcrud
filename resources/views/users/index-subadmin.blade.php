        ...
        <div class="row justify-content-evenly">
            <div class="col-8 col-md-8">
                ...
                <div class="lead">
                    ...
                    <div class="icon-add-new-user">
                        <a href="{{ route('createsubadmin') }}"><i class="bi bi-person-add"></i></a>
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td><a href="{{ route('showsubadmin', $user->id) }}"> <i class="bi bi-eye-fill"></i></a></td>
                                <td><a href="{{ route('editsubadmin', $user->id) }}"><i class="bi bi-pencil-square"></i></a></td>
                                <td>
                                    <form method="POST" action="{{ route('destroysubadmin', $user->id) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
            ...
            <div class="col-3 col-md-3">
                <div class="form-search">
                    ...
                    <form method="get" class="search" action="{{ route('searchsubadmin') }}">
